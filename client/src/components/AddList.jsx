...
function AddList({user, setUser, isConnected, setIsConnected}) {
    ...
    async function submitAll() {
        ...
        const newYear = inputs.list_year.charAt(0).toUpperCase() + inputs.list_year.slice(1).toLowerCase()
            ...
            <div className="big-form">
                <div className="list-form">
                    ...
                    <div className="flex-column">
                        ...
                        <Select style={styleCity} name={"list_city"} inputs={inputs} setInputs={setInputs} user={user} setUser={setUser} isConnected={isConnected} setIsConnected={setIsConnected} search={search1} list={cities}/>
                        {styleCity === "" ? null : <span className="little-text">Vous devez rentrer une ville</span>}
                        <Select style={styleTheme} name={"list_theme"} inputs={inputs} setInputs={setInputs} user={user} setUser={setUser} isConnected={isConnected} setIsConnected={setIsConnected} search={search2} list={themes}/>
                        {styleTheme === "" ? null : <span className="little-text">Vous devez rentrer un thème</span>}
                        <Select style={styleColor} name={"list_color"} inputs={inputs} setInputs={setInputs} user={user} setUser={setUser} isConnected={isConnected} setIsConnected={setIsConnected} search={search3} list={colors}/>
